...
Route::get('/sportainment/{slug}', [FrontController::class, 'sportainment'])->name('sportainment');
Route::get('/food-and-beverages', [FrontController::class, 'food_and_beverages'])->name('food-and-beverages');
Route::get('/food-and-beverage/{slug}', [FrontController::class, 'food_and_beverage'])->name('food-and-beverage');
Route::get('/lodgings', [FrontController::class, 'lodgings'])->name('lodgings');
Route::get('/lodging/{slug}', [FrontController::class, 'lodging'])->name('lodging');
...
Route::get('/activity-manajemen/{slug}', [FrontController::class, 'activity_manajemen'])->name('activity-manajemen');
