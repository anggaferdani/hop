    ...
    <div class="card">
      ...
      <div class="card-body">
        @if(auth()->user()->level == 'Superadmin')
          <form action="{{ route('superadmin.feature.update', Crypt::encrypt($feature->id)) }}" method="POST" class="needs-validation" novalidate="">
        @elseif(auth()->user()->level == 'Admin')
          <form action="{{ route('admin.feature.update', Crypt::encrypt($feature->id)) }}" method="POST" class="needs-validation" novalidate="">
        @endif
          @csrf
          @method('PUT')
