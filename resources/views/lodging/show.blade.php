        ...
        <form action="" method="POST" class="needs-validation" novalidate="">
          ...
          <div class="form-group">
            ...
            <select disabled class="form-control select2" name="harga">
              ...
              <option value="Rp.500.000 - Rp.1.000.000" @if($lodging->harga == 'Rp.500.000 - Rp.1.000.000')@selected(true)@endif>Rp.500.000 - Rp.1.000.000</option>
              <option value="> = Rp.1.000.000" @if($lodging->harga == '> = Rp.1.000.000')@selected(true)@endif>> = Rp.1.000.000</option>
            </select>
