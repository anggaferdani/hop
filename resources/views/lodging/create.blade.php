    ...
    <div class="card">
      ...
      <div class="card-body">
        @if (Auth::check())
          ...
          @endif
        @else
          <form action="{{ route('partner.lodging-post') }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate="">
        @endif
          @csrf
          ...
          <div class="form-group">
            <label for="">Fasilitas <span class="text-danger">*</span></label>
