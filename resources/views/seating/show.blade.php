      ...
      <div class="card-body">
        <form action="" method="POST" class="needs-validation" novalidate="">
          ...
          <div class="form-group">
            ...
            <input disabled type="text" class="form-control" name="seating" value="{{ $seating->seating }}">
            @error('seating')<div class="text-danger">{{ $message }}</div>@enderror
          </div>
          <div class="form-row">
            <div class="form-group col-md-6">
              <label for="">Created By</label>
              <input disabled type="text" class="form-control" name="created_by" value="{{ $seating->created_by }}">
              @error('created_by')<div class="text-danger">{{ $message }}</div>@enderror
            </div>
            <div class="form-group col-md-6">
              <label for="">Updated By</label>
              <input disabled type="text" class="form-control" name="updated_by" value="{{ $seating->updated_by }}">
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input disabled type="text" class="form-control" name="created_at" value="{{ $seating->created_at }}">
              @error('created_at')<div class="text-danger">{{ $message }}</div>@enderror
            </div>
            <div class="form-group col-md-6">
              <label for="">Updated At</label>
              <input disabled type="text" class="form-control" name="updated_at" value="{{ $seating->updated_at }}">
