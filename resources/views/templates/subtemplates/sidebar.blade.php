    ...
    <ul class="sidebar-menu">
      @if (Auth::check())
        @if(auth()->user()->level == 'Superadmin')
          ...
          <li class="{{ str_contains(Route::currentRouteName(), 'superadmin.pendaftar') ? 'active' : '' }}"><a class="nav-link" href="{{ route('superadmin.pendaftar.index') }}"><i class="fas fa-user"></i><span>Pendaftar<div class="badge badge-primary">{{ $pendaftarCount }}</div></span></a></li>
          ...
          <li class="{{ str_contains(Route::currentRouteName(), 'superadmin.food-and-beverage') ? 'active' : '' }}"><a class="nav-link" href="{{ route('superadmin.food-and-beverage.index') }}"><i class="fas fa-coffee"></i><span>Resto & Cafe<div class="badge badge-primary">{{ $foodAndBeverageCount }}</div></span></span></a></li>
          <li class="{{ str_contains(Route::currentRouteName(), 'superadmin.lodging') ? 'active' : '' }}"><a class="nav-link" href="{{ route('superadmin.lodging.index') }}"><i class="fas fa-building"></i><span>Hotel<div class="badge badge-primary">{{ $lodgingCount }}</div></span></span></a></li>
          <li class="{{ str_contains(Route::currentRouteName(), 'superadmin.public-area') ? 'active' : '' }}"><a class="nav-link" href="{{ route('superadmin.public-area.index') }}"><i class="fas fa-map"></i><span>Public Area<div class="badge badge-primary">{{ $publicAreaCount }}</div></span></span></a></li>
          <li class="{{ str_contains(Route::currentRouteName(), 'superadmin.activity-manajemen') ? 'active' : '' }}"><a class="nav-link" href="{{ route('superadmin.activity-manajemen.index') }}"><i class="fas fa-th"></i><span>Community<div class="badge badge-primary">{{ $activityManajemenCount }}</div></span></a></li>
        ...
        @if(auth()->user()->level == 'Admin')
          ...
          @if(auth()->user()->level_admin == 'Admin')
            ...
            <li class="{{ str_contains(Route::currentRouteName(), 'admin.pendaftar') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.pendaftar.index') }}"><i class="fas fa-user"></i><span>Pendaftar<div class="badge badge-primary">{{ $pendaftarCount }}</div></span></a></li>
            ...
            <li class="{{ str_contains(Route::currentRouteName(), 'admin.food-and-beverage') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.food-and-beverage.index') }}"><i class="fas fa-coffee"></i><span>Resto & Cafe<div class="badge badge-primary">{{ $foodAndBeverageCount }}</div></span></span></a></li>
            <li class="{{ str_contains(Route::currentRouteName(), 'admin.lodging') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.lodging.index') }}"><i class="fas fa-building"></i><span>Hotel<div class="badge badge-primary">{{ $lodgingCount }}</div></span></span></a></li>
            <li class="{{ str_contains(Route::currentRouteName(), 'admin.public-area') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.public-area.index') }}"><i class="fas fa-map"></i><span>Public Area<div class="badge badge-primary">{{ $publicAreaCount }}</div></span></span></a></li>
            <li class="{{ str_contains(Route::currentRouteName(), 'admin.activity-manajemen') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.activity-manajemen.index') }}"><i class="fas fa-th"></i><span>Community<div class="badge badge-primary">{{ $activityManajemenCount }}</div></span></a></li>
