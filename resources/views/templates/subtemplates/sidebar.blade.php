    ...
    <ul class="sidebar-menu">
      @if (Auth::check())
        @if(auth()->user()->level == 'Superadmin')
          ...
          <li class="{{ str_contains(Route::currentRouteName(), 'superadmin.lodging') ? 'active' : '' }}"><a class="nav-link" href="{{ route('superadmin.lodging.index') }}"><i class="fas fa-building"></i><span>Hotel</span></a></li>
        ...
        @if(auth()->user()->level == 'Admin')
          ...
          @if(auth()->user()->level_admin == 'Admin')
            ...
            <li class="{{ str_contains(Route::currentRouteName(), 'admin.lodging') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.lodging.index') }}"><i class="fas fa-building"></i><span>Hotel</span></a></li>
