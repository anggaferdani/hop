          ...
          <td><table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td align="left"><h4 style="font-family: Helvetica, Arial, sans-serif; font-size: 20px; font-weight:normal; color: #2C3E50; margin:0; mso-line-height-rule:exactly;">Berikut QR-Code hasil pemesanan tiket {!! $judul !!}@if(!empty($tiket)) [ {!! $tiket !!} ]@endif. QR-Code dapat ditunjukan ke petugas terkait saat mengikuti kegiatan sebagai bukti pemesanan.</h4></td>
                    </tr>
                    <tr>
                      <td align="center" height="25" style="height:25px; font-size: 0;">&nbsp;</td>
                    </tr>
