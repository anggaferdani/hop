  ...
  <tr>
    <td align="center">
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" class="wrapper">
        ...
        <tr>
          <td align="center"><a href="{{ route('index') }}" title="" target="_blank"><img src="{{ $message->embed(public_path('front/img/logo.png')) }}" width="66" height="79" alt="" style="display: block; border:0; width:66px; height:79px;" border="0"></a></td>
        </tr>
        <tr>
          <td align="center" height="25" style="height:25px; font-size: 0;">&nbsp;</td>
        </tr>
